...
class AISearchOptimizer:
    """
    A simple AI search optimization evaluator that sends website data to LLM
    ...
    def _analyze_website(self, website_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        response_data = self._call_azure_openai(system_prompt, user_prompt)
    ...
    def generate_report(self, website_url: str, analysis: Dict[str, Any], recommendations: Dict[str, Any]) -> Dict[str, Any]:
        ...
        report_content = self._call_azure_openai(system_prompt, user_prompt)
